...
class ChangeMaterials(Operator):
    ...
    which_objects = EnumProperty(
            ...
            default = 'Selected',
            description = "Give selected objects a common material")

    by_name = StringProperty(
            name = "Object name(s)",
            description = "Search by object names. Separate multiple names with commas")

    partial_match = BoolProperty(
            name = "Allow partial matches?", 
            default = False,
            description = "Allow partial matches for object names?")

    is_not = BoolProperty(
            name = "Is not named",
            default = False,
            description = "Filter by objects not named")

    create_new_material = BoolProperty(
            name = "Create new material?",
            default = False,
            description = "Create new material if none exist?")
    ...
    change_diffuse_intensity = BoolProperty(
            name = "Diffuse intensity",
            default = False,
            description = "Change object diffuse intensity?")

    new_diffuse_intensity = FloatProperty(
            name = "",
            default = .8,
            min = 0,
            max = 1,
            description = "Set diffuse intensity value")

    change_specular_intensity = BoolProperty(
            name = "Specular intensity",
            default = False,
            description = "Change object specular intensity?")

    new_specular_intensity = FloatProperty(
            name = "",
            default = .5,
            min = 0,
            max = 1,
            description = "Set specular intensity value")

    change_emit = BoolProperty(
            name = 'Emit',
            default = False,
            description = "Change object light emit?")

    new_emit = FloatProperty(
            name = "",
            default = 1,
            min = 0,
            max = 5,
            description = "Set new emit value")

    change_transparency = BoolProperty(
            name = "Transparency",
            default = False,
            description = 'Change object transparency?')

    new_transparency = EnumProperty(
            name = "",
            items = [
                ('Mask', 'Mask', 'Mask'),
            ...
            default = 'Z-Transparency',
            description = "Set new transparency type")

    change_alpha = BoolProperty(
            name = "Alpha",
            default = False,
            description = 'Change alpha value?')

    new_alpha = FloatProperty(
            name = "",
            default = 1,
            min = 0,
            max = 1,
    ...
    change_specular = BoolProperty(
            name = "Specular",
            default = False,
            description = "Change specular value?")

    new_specular = FloatProperty(
            name = "",
            default = 1,
            min = 0,
            max = 1,
            description = "Set new specular value")

    change_fresnel = BoolProperty(
            name = "Fresnel",
            default = False,
            description = "Change fresnel value?")

    new_fresnel = FloatProperty(
            name = "",
            default = 0,
            min = 0,
            max = 5,
            description = "Set new fresnel value")

    change_material_type = BoolProperty(
            name = "Material type",
            default = False,
            description = "Change material type?")

    new_material_type = EnumProperty(
            name = "",
            items = [
                ('Surface', 'Surface', 'Surface'),
                ('Wire', 'Wire', 'Wire')
            ],
            description = "Set new material type")
    ...
    red_start = FloatProperty(
            name = "Red start",
            default = 0,
            min = 0,
            max = 255,
            description = "set start red channel range")

    red_end = FloatProperty(
            name = "Red end",
            default = 255,
            min = 0,
            max = 255,
            description = "set end red channel range")

    green_start = FloatProperty(
            name = "Green start",
            default = 0,
            min = 0,
            max = 255,
            description = "set start green channel range")

    green_end = FloatProperty(
            name = "Green end",
            default = 255,
            min = 0,
            max = 255,
            description = "set end green channel range")

    blue_start = FloatProperty(
            name = "Blue start",
            default = 0,
            min = 0,
            max = 255,
            description = "set start blue channel range")

    blue_end = FloatProperty(
            name = "Blue end",
            default = 255,
            min = 0,
            max = 255,
            description = "set end blue channel range")
    ...
    def execute(self, context):
        ...
        for ob in ob_list:
            ...
            def random_material(
                ...
                g = random.randint(g_start, g_end)
                b = random.randint(b_start, b_end)
            ...
            if self.random_color:
                ...
                if self.create_new_material:
                    ...
                    mat.diffuse_color = random_material(
                                            self.red_start,
                                            self.red_end,
                                            self.green_start,
                                            self.green_end,
