...
class boundingBox(Operator):
    ...
    bounding_box = EnumProperty(
            ...
            default = 'Single',
            description = "Type of bounding box(es) to generate")

    box_color = FloatVectorProperty(
            name = "Bbox color",
            default = (0.0, 1.0, 0.0),
            min = 0.0,
            max = 1.0,
    ...
    use_wireframe = BoolProperty(
            name = "Wireframe",
            default = False,
            description = "Use wireframe?")

    change_thickness = FloatProperty(
            name = "Thickness",
            default = 0.02,
            min = 0,
            max = 1,
    ...
    change_offset = FloatProperty(
            name = "Offset",
            default = 0,
            min = -5,
            max = 5,
            description = "Wireframe offset")

    relative_thickness = BoolProperty(
            name = "Relative thickness",
            default = False,
            description = "Use relative thickness?")

    apply_wireframe = BoolProperty(
            name = "Apply wireframe?",
            default = False,
            description = "If left unchecked, wireframe will be set but still manipulatable, if checked wireframe will be applied and no longer manipulatable (will remove modifier from modifier stack)")
