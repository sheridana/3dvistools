...
class jumpFixing(Operator):
    ...
    delete_method = EnumProperty(
            ...
            default = 'Box',
            description = "Jump deletion method")

    convert_to_mesh = BoolProperty(
            name = "Convert to mesh?",
            default = True,
            description = "If using the box delete method, curves have to be converted to meshes for vertices to be selected and deleted")

    x_point = BoolProperty(
            name = "X point range",
            default = False,
            description = "Remove vertices on x axis")
    ...
    x_start = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "Start of x coordinate range")
    ...
    x_end = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "End of x coordinate range")

    y_point = BoolProperty(
            name = "Y point range",
            default = False,
            description = "Remove vertices on y axis")
    ...
    y_start = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "Start of y coordinate range")
    ...
    y_end = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "End of y coordinate range")

    z_point = BoolProperty(
            name = "Z point range",
            default = False,
            description = "Remove vertices on z axis")
    ...
    z_start = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "Start of z coordinate range")
    ...
    z_end = FloatProperty(
            ...
            min = -100000,
            max = 100000,
            description = "End of z coordinate range")
