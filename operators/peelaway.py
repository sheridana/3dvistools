...
class peelAway(Operator):
    ...
    offset_planes = BoolProperty(
            name = "Offset planes?",
            default = False,
            description = "Offset planes in some direction")
    ...
    offset_direction = EnumProperty(
            ...
            default = 'Z',
            description = "Direction to offset planes")
    ...
    start_z = FloatProperty(
            name = "Start Z",
            default = 0,
            max = 100000,
            min = -100000,
            description = "Starting z value")
    ...
    peel_away = BoolProperty(
            name = "Peel away?",
            default = False,
            description = "Peel away planes?")
    
    reverse = BoolProperty(
            name = "Reverse?",
            default = False,
            description = "Peel away in reverse?")

    number_of_planes = FloatProperty(
    ...
    frame_step = FloatProperty(
            ...
            max = 100000,
            min = -100000,
            description = "Number of frames to peel by")

    calculate_frames = BoolProperty(
            name = "Calculate frames?",
            default = False,
            description = "Calculate number of frames to peel away based on number of planes selected")
